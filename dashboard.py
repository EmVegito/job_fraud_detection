...
def load_models():
    ...
    try:
        ...
        st.error("Model files not found. Please ensure 'preprocessor.pkl' and 'final_model.pkl' are in the same directory.")
        return None, None
...
def main():
    ...
    if uploaded_file is not None:
        ...
        if X_processed is not None:
            ...
            with tab2:
                ...
                if isinstance(model, SVC):
                    st.markdown("""
                    ###For `SVM models` with Kernel: `rbf` SHAP takes too much time.
                                
                    I will update this when I've Developed an alternative as I don't have much time before submision deadline
                    """)
                else:
        ...
        **📋 Requirements:**
        ...
        - Ensure `preprocessor.pkl` and `final_model.pkl` are in the same directory
        """)
